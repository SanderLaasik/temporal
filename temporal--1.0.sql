...
BEGIN
	...
	EXECUTE format('
		...
		FOR EACH STATEMENT EXECUTE PROCEDURE TEMPORAL.CHK_PACKED_ON_DURING(''%s'');
	...
	EXECUTE format('
		...
		AFTER INSERT OR UPDATE OR DELETE ON %I.%I
		DEFERRABLE INITIALLY DEFERRED
		FOR EACH STATEMENT EXECUTE PROCEDURE TEMPORAL.CHK_WHEN_UNPACKED_THEN_KEY(''%s'',''%s'', ''%s'');
	...
	EXECUTE format('
		...
		AFTER INSERT OR UPDATE OR DELETE ON %I.%I
		DEFERRABLE INITIALLY DEFERRED
		FOR EACH STATEMENT EXECUTE PROCEDURE TEMPORAL.CHK_NO_REDUNDANCY_ACROSS_SINCE_AND_DURING (%s, %s, %s, %s);
	...
	EXECUTE format('
		...
		AFTER INSERT OR UPDATE OR DELETE ON %I.%I
		DEFERRABLE INITIALLY DEFERRED
		FOR EACH STATEMENT EXECUTE PROCEDURE TEMPORAL.CHK_NO_CIRCUMLOCUTION_ACROSS_SINCE_AND_DURING (%s, %s, %s, %s);
